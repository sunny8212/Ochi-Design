          ...
          <div className="flex items-center justify-center gap-10">
            ...
            <div className="flex items-center justify-center w-[15vw] h-[15vw] rounded-full bg-zinc-100">
              <div className="relative w-2/3 h-2/3 rounded-full bg-zinc-900 flex items-center justify-center">
                <div style={{transform: `translate(-50%, -50%) rotate(${rotate}deg)`}} className="absolute top-1/2 left-1/2 -translate-y-[50%] -translate-x-[50%] line w-full h-10 border-red-600"></div>
