...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20 relative'>
      <div className="w-1/2 font-['Founders_Grotesk_X_Condensed flex flex-col justify-between'] h-full">
        <div className="heading ">
          <h1 className='text-[5vw] uppercase -mb-10 font-semibold'>Eye</h1>
          <h1 className='text-[5vw] uppercase -mb-10 font-semibold'>Opening</h1>
          
        </div>
        <h3><svg className='absolute bottom-20 left-25' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="w-1/2">
      <h1 className='text-[4vw] uppercase -mb-10 font-semibold leading-none'>Presentations</h1>
        <div className="dets font-['Neue_Montreal'] mt-20 ">
        <div className="text-[1vw] font-light mt-10 ">
          {/* Social Links */}
          ...
          <div className="mb-5 ">
            ...
            <ul className="ml-5 underline ">
              <li>202-1965 W 4th Ave</li>
              <li>Vancouver, Canada</li><br></br>
          ...
          <div>
            ...
            <ul className="ml-5">
              <li>
                <a href="mailto:hello@ochi.design" className="underline">
                  hello@ochi.design
                </a>
              </li>
            </ul>
        ...
        {/* Copyright Section */}
        <div className="mt-[250px] text-sm text-zinc-400">
          <p>&copy; 2024 Eye-Opening Presentations. All rights reserved.</p>
        </div>
      </div>
      </div>
